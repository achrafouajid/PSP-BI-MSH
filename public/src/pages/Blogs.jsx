...
import generate from "../data/fakerdata";
import { tagColorMap } from "../data/fakerdata";

export const data = generate();
const Blogs = ({ image, title, author, date, tag }) => (
  <div className="m-2 md:m-10 mt-24 p-2 md:p-10 bg-white rounded-3xl">
    <Header category="Blogs" title="Blog" />
    <div className="flex">
          ...
          <div className="filter-card mb-3 bg-white rounded-lg p-6">
            ...
            {data.map((e) => (
              <div className=" mb-3 flex" key={e.id}>
                <div className="w-1/2">
                  <img src={e.image} className="rounded-xl" alt="watch" />
                </div>
                <div className="w-1/2">
